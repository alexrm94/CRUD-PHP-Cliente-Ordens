...
class Database
{
    ...
    public function execute_non_query($sql, $parameters = null)
    {
        ...
        try {
            ...
            // finish transaction
            //While autocommit mode is turned off, changes made to the database 
            //via the PDO object instance are not committed until you end the 
            //transaction by calling PDO::commit().
            $connection->commit();
